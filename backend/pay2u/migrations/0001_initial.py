# Generated by Django 3.2 on 2024-03-26 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='pay2u.rate', verbose_name='Тариф')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pay2u.services', verbose_name='Сервис')),
            ],
        ),
        migrations.CreateModel(
